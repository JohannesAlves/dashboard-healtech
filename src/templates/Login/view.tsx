  ...
  return (
    <Grid container component="main" sx={{ height: '100vh' }}>
      <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
        ...
        >
          <Typography variant="h5" sx={{ fontWeight: 'bold', color: '#9D9D9D' }}>
            LOGO
          </Typography>
          ...
          >
            <TextField
              ...
              helperText={errors.email?.message || (errors.incorretLogin?.message as string)}
            />
            ...
            <TextField
              ...
              helperText={errors.password?.message || (errors.incorretLogin?.message as string)}
              {...register('password')}
            />
